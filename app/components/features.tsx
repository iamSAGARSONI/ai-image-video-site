  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
      {features.map((feature) => (
        <div
          key={feature.id}
          className="feature-block flex flex-col justify-center text-center items-center bg-gray-800 p-6 rounded-lg shadow-lg h-[300px] hover:shadow-xl transition-shadow"
        >
